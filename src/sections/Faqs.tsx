        ...
        <section className="py-24">
            <div className="container">
                ...
                <h2 className="text-6xl font-medium mt-6 text-center max-w-xl mx-auto">
                    Questions? We've got <span className="text-yellow-300">answers</span>
                </h2>
                        ...
                        >
                            <div className="flex justify-between items-center">
                                ...
                                <svg
                                    ...
                                    className={twMerge("feather feather-plus text-yellow-400 flex-shrink-0", selectedIndex === faqIndex && "rotate-45")}
                                >
